...
public class MockVisitorRepositoryImpl implements VisitorRepository{
    ...
    private static Visitor visitor = new Visitor(42L, "Алексей", "Шипилев", Sex.MALE, null, LocalDateTime.now().minus(35, ChronoUnit.YEARS), LocalDate.now().minus(6, ChronoUnit.DAYS),
            "email", "phone", null, null, "twitter", null, null, "description", 5000, null, null, null, null);
